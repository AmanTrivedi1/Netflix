  ...
  return (
    showPinContainer && (
      <div className="z-[100] bg-[#141414] flex-col min-h-screen absolute left-0 top-0 justify-center flex items-center right-0">
        ...
        <h1 className="text-gray-400 font-bold text-xs sm:text-[16px] mb-4">
          Profile Lock is currently ON
        </h1>
        {pinError ? (
          <h2 className="text-[#e6b209] font-bold text-center  text-[18px]  sm:text-[24px] md:text-[30px]">
            Whoops, wrong PIN. Please try again
          </h2>
        ) : (
          <h2 className="text-white font-bold text-[18px] text-center sm:text-[24px] md:text-[30px]">
